      ...
      <div class="col-md-6 col-lg-5">
        <div class="login-card p-4 p-md-5">
          <div class="text-center mb-4">
           <img src="/images/stl.svg" alt="Superset Logo" class="login-logo" style="display: block; margin-left: auto; margin-right: auto;">
           <h2 class="fw-bold" style="font-weight: bold; font-size: 36px;">Student Login</h2>
          </div>
    ...
    <!-- Github Button -->
     <a href="#" class="btn btn-dark me-2 p-3 rounded-circle d-flex align-items-center justify-content-center" aria-label="Login with GitHub" style="transition: all 0.3s ease;">
        <i class="fab fa-github text-white" style="font-size: 1.5rem;"></i>
          ...
          <form id="loginForm" action="${pageContext.request.contextPath}/student/checkstudentlogin" method="POST">
            <div class="mb-3">
    ...
    <span class="input-group-text" id="togglePassword" style="cursor: pointer;">
      <i class="fas fa-eye" id="eyeIcon"></i>
          ...
          <div class="text-center mt-3">
            <a href="/student/forgotpass" class="forgot-password">Forgot password?</a>
          </div>
          <hr>
          <div class="text-center">
            <p class="signup-link">Don't have an account? <a href="/student/studentreg" class="text-decoration-none">Sign up</a></p>
          </div>
        </div>
      </div>
    </div>
